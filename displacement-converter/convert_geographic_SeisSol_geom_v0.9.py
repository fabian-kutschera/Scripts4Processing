...
parser = argparse.ArgumentParser(description="transform the geometry array of a SeisSol surface output file to the geocentric coordinate system")
...
if isHdf5:
    fname = os.path.join(mypath, "geometry_WGS84.h5")
...
with open(fname_xdmf, "w") as fout:
    ...
    for line in lines:
        if isHdf5:
            ...
            loca = os.path.join(path2, "geometry_WGS84.bin")
