...
#--------------------------
    ...
    def fixup(current_data):
        ...
        pylab.xticks(ticks = np.arange(22, 30, 1), labels=[])
        pylab.yticks(ticks = np.arange(33, 42, 1), labels=[])
        pylab.text(27.9, 39.5, time_string, fontsize=15)
        pylab.grid(True)
...
#        img = pylab.imshow(a, cmap=geoplot.tsunami_colormap)
        ...
        #plot Gauge names
        plt.text(25.152692-0.2, 35.348475-0.25, s="hrak", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
        plt.text(26.921840-0.25, 35.418600-0.25, s="noa-03", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
        plt.text(26.370550-0.2, 38.971880+0.15, s="plom", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
        plt.text(24.945808-0.2, 37.439969-0.25, s="syro", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
        plt.text(27.423453-0.2, 37.032170+0.15, s="bodr", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
        plt.text(27.287792-0.2, 36.898362-0.25, s="kos1", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
        plt.text(27.287792-0.2, 36.891013-0.44, s="kos2", fontsize=14, bbox=dict(facecolor='white', alpha=0.5, edgecolor='white', pad=0.5))
...
#    plotitem.pcolor_cmap = geoplot.tsunami_colormap
    ...
    plotitem.amr_celledges_show = [0,0,0,0]
    plotitem.patchedges_show = 0
    plotaxes.xlimits = [22,29]
    plotaxes.ylimits = [34,41]
...
#    plotdata.print_framenos = [10,20]          # list of frames to print
